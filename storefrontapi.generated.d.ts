...
export type HomepageWatchesQueryVariables = StorefrontAPI.Exact<{
  country?: StorefrontAPI.InputMaybe<StorefrontAPI.CountryCode>;
  language?: StorefrontAPI.InputMaybe<StorefrontAPI.LanguageCode>;
}>;

export type HomepageWatchesQuery = {
  products: {
    nodes: Array<
      Pick<StorefrontAPI.Product, 'id' | 'title' | 'handle' | 'productType'> & {
        priceRange: {
...
export type StoreCollectionsDirectoryQueryVariables = StorefrontAPI.Exact<{
  country?: StorefrontAPI.InputMaybe<StorefrontAPI.CountryCode>;
  language?: StorefrontAPI.InputMaybe<StorefrontAPI.LanguageCode>;
}>;

export type StoreCollectionsDirectoryQuery = {
  collections: {
    nodes: Array<
      Pick<
        StorefrontAPI.Collection,
...
interface GeneratedQueryTypes {
  ...
  '#graphql\n  query HomepageWatches($country: CountryCode, $language: LanguageCode)\n    @inContext(country: $country, language: $language) {\n    products(first: 6, query: "product_type:Watch OR product_type:Watches") {\n      nodes {\n        id\n        title\n        handle\n        productType\n        priceRange {\n          minVariantPrice {\n            amount\n            currencyCode\n          }\n        }\n        compareAtPriceRange {\n          minVariantPrice {\n            amount\n            currencyCode\n          }\n        }\n        featuredImage {\n          id\n          url\n          altText\n          width\n          height\n        }\n        images(first: 3) {\n          nodes {\n            id\n            url\n            altText\n            width\n            height\n          }\n        }\n      }\n    }\n  }\n': {
    return: HomepageWatchesQuery;
    variables: HomepageWatchesQueryVariables;
  };
  ...
  '#graphql\n  query StoreCollectionsDirectory(\n    $country: CountryCode\n    $language: LanguageCode\n  ) @inContext(country: $country, language: $language) {\n    collections(first: 10) {\n      nodes {\n        id\n        title\n        handle\n        description\n        image {\n          id\n          url\n          altText\n          width\n          height\n        }\n      }\n    }\n  }\n': {
    return: StoreCollectionsDirectoryQuery;
    variables: StoreCollectionsDirectoryQueryVariables;
  };
